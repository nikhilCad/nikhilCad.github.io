...
\pt \textbf{Languages:} Python, C, C++, Java, SQL, JavaScript, TypeScript \\
\pt \textbf{Frameworks:} ReactJS, NextJS, NodeJS, AngularJS, Flask, Firebase, PostgreSQL PyTorch, Godot\\
\pt \textbf{Developer Tools:}  Git, Heroku, Vercel, LaTex, VSCode, IntelliJ\\
\pt \textbf{Libraries:}  ChakraUI, Pandas, Geopandas, Bootstrap, libGDX\\
