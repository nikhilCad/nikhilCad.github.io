...
\pt Used \textbf{Python,} \textbf{Pytorch,} \textbf{TensorFlow} for performing operations like denoising on \textbf{Hyperspectral Images}\\
\sectionsep
...
\pt \textbf{Hackerank : 5 stars in Python and C} \href{https://www.hackerrank.com/nikhilcaddilac?hr_r=1}{[Link]}\\
%\pt \textbf{Other Technologies:} PyTorch, TensorFlow, Scikit-learn, Git, Flutter, Android Studio, ReactJS, Nodejs, Bootstrap, Pandas, Geopandas, Heroku, Godot
