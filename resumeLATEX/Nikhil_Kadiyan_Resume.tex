...
\position{Created Todos App in React \href{https://github.com/nikhilCad/TodoReactApp}{[Code]}}{Jan '22}
...
\position{Python News Reader App \href{https://github.com/nikhilCad/pySimpleRSS}{[Code]}}{Oct '21}
\pt Created a News Reader App using Python \\
\pt Features \\
\hspace{5mm} \pt Add your sources using RSS feeds available at their website \\
\hspace{5mm} \pt Parses the website using beautifulsoup so you don't have to open each news in browser \\
\sectionsep
