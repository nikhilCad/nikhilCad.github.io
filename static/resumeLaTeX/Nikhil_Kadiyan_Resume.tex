...
\pt Colloborated in building a \textbf{Salesforce LWC plugin} to embed \textbf{ThoughtSpot dashboards and Liveboards} directly within Salesforce, enabling contextual analytics inside CRM workflows.\\
\pt Built \textbf{Spotbuild}, an \textbf{AI-powered content generation system} that auto-generates \textbf{Liveboard answers and worksheets} from user prompts, enabling prospects to quickly assess ThoughtSpot’s analytical capabilities.\\
\pt Created \textbf{SpotterCode}, a MCP server to help user embed BI websites faster using natural language, also providing \textbf{relevant documentation} for deeper understanding.\\
\sectionsep
...
\pt Supports full article content extraction, TTS, and integrated podcast media enclosure across \textbf{100+ feeds}.\\
