...
\position{Member of Technical Staff 2 | Java, Golang, React, Typescript, GraphQL}{Jul '24 - Present}
...
\pt Debugged a Mixpanel issue that led to excessive event firing during testing, \textbf{causing high costs}. Reduced the events from 20 million to actual value of 300k, with the remaining events being from dev clusters used by customers, ahead of a contract renewal saving the company 30,000 dollars.\\ % 30 grand that might have gone for the new plan, we bought for 23K finally, else it would have been 50K range
