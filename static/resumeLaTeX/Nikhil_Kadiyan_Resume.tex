...
%  Edge Onboarding (ongoing) - Creating a new onboarding flow which introduces Spotter and TSA to a first time free trial user of Thoughtspot.
...
%  Bug fixing / ops
% Munshi Org Aware - Customer commit
\position{Member of Technical Staff | Java, Golang, React, Typescript, GraphQL}{Jul '24 - Present}
\pt Achieved a 90\% decrease in page load times by migrating the impressions Cassandra database for the product's homepage from Munshi V1 to V2, achieved by changing the schema of the database\\
...
\pt Debugged a Mixpanel issue that led to excessive event firing during testing, causing high costs. Reduced the events from 20 million to actual value of 300k, with the remaining events being from dev clusters used by customers, ahead of a contract renewal.\\
...
% \pt Implemented a rate limiter for share API using Redis
\sectionsep
...
\pt Solved \textbf{400+} Data Structures and Algorithm problems on \textbf{Leetcode} \href{https://leetcode.com/anidnottaken/}{[Link]}, rated \textbf{1586} on contests.\\ 
