...
\position{ThoughtSpot | Member of Technical Staff 2 | Java, Golang, React, Typescript, GraphQL}{Jul '24 - Present | Hyderabad}
...
\pt \textbf{Diagnosed and resolved} a Mixpanel overtracking issue ahead of a renewal, \textbf{reducing test event volume by 98.5\% (20M to 300K)} and \textbf{saving \$30K}.\\ % 30 grand that might have gone for the new plan, we bought for 23K finally, else it would have been 50K range
\pt Added frontend support for \textbf{monitor alerts in Slack}, enabling users to receive data updates directly in Slack without opening the BI tool, increasing user engagement.\\
...
\pt Migrated schema viewer from Angular to React by creating new React components and making GraphQL calls to the backend. Also resolved design issues in the legacy UI during migration.\\
...
\pt Implemented Knowledge Cards that show users information about a selected table including database, schema, and author. Made API calls to the backend.\\
...
\pt Implemented \textbf{posts, comments, homepage, and suggested users} functionality for enhanced user engagement.\\
...
\pt \textbf{Frameworks \& Libraries:} React, Next.js, Node.js, Angular, Flask, Jest, Playwright, Prisma, Pandas, Chakra UI, Bootstrap \\
