...
\pt Executed the handling of communication events as a multi tenant service as measured by the successful implementation of a Slack event handling for all clusters within a tenant and making the app comply with Slack guidelines. \\
