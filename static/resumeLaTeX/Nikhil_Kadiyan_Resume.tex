...
\projectposition{Bachelor of Technology (CGPA: 8.4 upto Sem 7) \normalfont}{ }
...
\pt Shipped \textbf{Filter and Sort feature} for worksheet tables and columns along with one team member. Collaborated with the backend team to add new parameters in existing API to include \textbf{tags, authors and database info} to sort the tables.  Increased efficiency for analyst users by 20\%\\
...
\projectposition{Real Time Chatroom Application \href{https://github.com/nikhilCad/real-time-chatroom}{[Code]} \href{https://real-time-chatroom-production.up.railway.app/}{[Live]}}{}
...
\pt \textbf{Frameworks:} Spring Boot, ReactJS, NextJS, NodeJS, Angular, Flask, Firebase, PyTorch, Godot\\
\pt \textbf{Developer Tools:}  Git, Heroku, Vercel, LaTex, VSCode, IntelliJ\\
\pt \textbf{Libraries:}  Prisma, Pandas, Geopandas, ChakraUI Bootstrap, rayLib\\
...
\pt Solved 250+ Data Structures and Algorithm problems on \textbf{Leetcode} \href{https://leetcode.com/anidnottaken/}{[Link]} \\ 
\pt Achieved a highest Rating of 1708, 3 stars in \textbf{Codechef} \href{https://www.codechef.com/users/nikhilcad}{[Link]} \\ 
