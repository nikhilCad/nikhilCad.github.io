...
\pt Debugged a Mixpanel issue that led to excessive event firing during testing, \textbf{causing high costs}. Reduced the events from 20 million to actual value of 300k, with the remaining events being from dev clusters used by customers, ahead of a contract renewal.\\
